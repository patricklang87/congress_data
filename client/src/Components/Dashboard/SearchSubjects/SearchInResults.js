...
import { setSearchInSubjectsTerm } from '../../../redux/searchSlice';

export default function SearchInResults() {
    const dispatch = useDispatch();

    const handleChange = (i) => {
        dispatch(setSearchInSubjectsTerm(i))
    }
    ...
    return (
        <div>
             <div onClick={toggleNavVisible}>
                <span style={{display: "inline"}} >&#10148;</span><span><strong> Filter Results</strong></span>
            </div>
